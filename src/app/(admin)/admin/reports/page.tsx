          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">
                Export all published research with author, adviser, type, publication date, and engagement metrics (views/downloads).
              </p>
            </div>
          </div>

          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-4">
            <h3 className="text-sm font-semibold text-blue-900 dark:text-blue-300 mb-2">CSV Columns:</h3>
                      ...
                      <tbody>
                        {topResearch.map((item, index) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-sm text-center text-gray-900 dark:text-gray-100 font-bold">
        ...
        <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-2xl p-6">
          ...
          <ul className="text-sm text-orange-800 dark:text-orange-200 space-y-2">
            <li className="flex items-start gap-2">
              <Download size={18} className="flex-shrink-0 mt-0.5 text-orange-600 dark:text-orange-400" />
              <span>
                <strong>CSV Format:</strong> All exports use standard CSV format compatible with Excel, Google Sheets, and other spreadsheet applications
              </span>
            </li>
            <li className="flex items-start gap-2">
              <Download size={18} className="flex-shrink-0 mt-0.5 text-orange-600 dark:text-orange-400" />
              <span>
                <strong>Date Stamped:</strong> All exports include the current date in the filename for easy tracking
              </span>
            </li>
            <li className="flex items-start gap-2">
              <Download size={18} className="flex-shrink-0 mt-0.5 text-orange-600 dark:text-orange-400" />
              <span>
                <strong>Complete Data:</strong> Exports include all relevant metrics and information for compliance and analysis
              </span>
            </li>
          </ul>
        </div>
