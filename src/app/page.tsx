        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">Every upload is stored and versioned. Never lose track of which file contains the latest changes.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">Advisers comment directly on your files, reducing the wait time between submission and revision.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600">Always know exactly where you stand. Real-time updates on approval status and requirements.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500">From proposal to final approval in five simple steps.</p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12 text-center">
            <div>
              ...
              <p className="text-blue-100">Upload manuscripts, track revision history, and view panel feedback in real-time.</p>
            </div>
            <div>
              <h4 className="text-2xl font-bold mb-4">For Advisers</h4>
              <p className="text-blue-100">Efficiently review submissions, leave structured comments, and manage student loads.</p>
            </div>
            <div>
              <h4 className="text-2xl font-bold mb-4">For Admin</h4>
              <p className="text-blue-100">Monitor overall research metrics, manage user roles, and archive completed projects.</p>
            </div>
          </div>
        </div>
      </section>
